...
label MC_Livingroom_Movie_11AM_Jennifer_Label:
    ...
    McMom "[MC_upper]!!! WHY ARE YOU STILL WATCHING TV?!"
    scene MC_Livingroom_Movie_11AM_Jennifer_3 with Dissolve(0.5)
    McMom "GET DRESSED RIGHT NOW!!!"
    ...
    menu:
        "Go to school now" if beenToSchoolOnce:
            ...
            McMom "GO GET DRESSED RIGHT NOW!!!"
            McMom "I WILL TAKE THIS TV AWAY FROM YOU!!!"
            ...
            McMom "THE GIRLS ARE ALREADY IN THE CAR, WHAT ARE YOU DOING?!"
            ...
            McMom "You better not do this again, understood?!"
            scene BlackScreen with Dissolve(0.5)
            "..."
        ...
        "Don't":
            ...
            McMom "...."
            scene MC_Livingroom_Movie_11AM_Jennifer_12 with Dissolve(0.5)
            McMom "Well... you should have told me sooner and not make me wait for you this long!"
            scene MC_Livingroom_Movie_11AM_Jennifer_14 with Dissolve(0.5)
            MC "Sorry, mom, it won't happen again."
            scene MC_Livingroom_Movie_11AM_Jennifer_12 with Dissolve(0.5)
            McMom "Yeah, it better be that way!"
