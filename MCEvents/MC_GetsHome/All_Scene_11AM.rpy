...
label MC_GetsHome_All_11AM:
    ...
    menu:
        "Knock":
            ...
            Clair "How much longer do you want us to wait, mom?!"
            Clair "Do you even know if he finished dressing up?!"
            scene All_Scene_11AM_2 with Dissolve(0.5)
            McMom "He should be here any moment now, Claire..."
            McMom "Have a little patience, please..."
            scene All_Scene_11AM_3 with Dissolve(0.5)
            "{color=#808080}*Knock, knock, knock!!!*"
            scene All_Scene_11AM_4 with Dissolve(0.5)
            McMom "Huh? Who can it be right now?"
            scene All_Scene_11AM_5 with Dissolve(0.5)
            McMom "YEAH, WHO IS IT?"
            ...
            Clair "You are all an embarrassment..."
