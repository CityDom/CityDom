...
default ShowMomStats = False
default ShowMomBodyScreen = False
default ShowBigSisStats = False
default ShowBigSisBodyScreen = False
default ShowLilSisStats = False
default ShowLilSisBodyScreen = False
default GoToMomStats = False
default GoToBigSisStats = False
default GoToLilSisStats = False
default StatScreenShown = False
default ShouldSeeSwitchSceneButton = False
default ShowMomScheduleScreen = False
default ShowLilSisScheduleScreen = False
default ShowBigSisScheduleScreen = False
default ShowMomScheduleScreenWeekend = False
default ShowLilSisScheduleScreenWeekend = False
default ShowBigSisScheduleScreenWeekend = False
...
# default CharFront = "CharStats/momFront.png"
# default CharBack = "CharStats/momBack.png"
# default CharLVL = "Levels/[Mom_level].png"
# default CharInfo = "[Mom_Info1]"
# default CharCorruption = "[Mom_Corruption]"
# default CharObedience = "[Mom_Obedience]"
# default CharLove = "[Mom_love]"
# default MaxProgressReached = False

# Create character object
define McMom = Character("Mom")
define Isabella = Character("Isabella")
define Clair = Character("Claire")
...
default all_characters = ["McMom", "Isabella", "Clair", "Maria", "Alis", "Sophie", "Lola", "Selina", "Helena", "Dorothy", "Leya", "Greta", "Jannice", "Criss"]

default character_data = {
    "Mom": {"front_img": "momFront.png", "back_img": "momBack.png", "pos_x": 584, "pos_y": 61},
    "LilSis": {"front_img": "sisFront.png", "back_img": "sisBack.png", "pos_x": 689, "pos_y": 61},
    "BigSis": {"front_img": "ClairFront.png", "back_img": "ClairBack.png", "pos_x": 794, "pos_y": 61},
...
image house = im.Scale("MomBody.png", 1920, 1080)

############ MOM STATS #################################################################################
default Mom_Corruption = 0
default Mom_Obedience = 0
default Mom_love = 0
default Mom_level = 1
default Mom_maxLevel = 1

############ LilSis STATS #################################################################################
default LilSis_Corruption = 0
default LilSis_Obedience = 0
default LilSis_love = 0
default LilSis_level = 1
default LilSis_maxLevel = 1

############ BigSis STATS #################################################################################
default BigSis_Corruption = 0
default BigSis_Obedience = 0
default BigSis_love = 0
default BigSis_level = 1
default BigSis_maxLevel = 1
