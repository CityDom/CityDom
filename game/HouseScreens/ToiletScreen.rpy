...
screen HouseToiletScreen():
    ...
    if calendar.Day not in [0, 6]:
        on "show" action If(calendar.Hours == 2, [Hide("HouseToiletScreen"), Jump("BigSisMorningEvent34")])
        on "show" action If(calendar.Hours == 12, [Hide("HouseToiletScreen"), Jump("LilSisNightEvent34")])
        ...
        if not MapScreenShown and not StatsScreenShown:
            ...
            if 0 <= calendar.Hours <= 20:
                ...
                imagebutton:
                    ...
                    focus_mask True
    elif calendar.Day == 0 or calendar.Day == 6:  # Weekend logic
        # on "show" action If(calendar.Hours == 2, [Hide("HouseToiletScreen"), Jump("BigSisMorningEvent34")])
        # on "show" action If(calendar.Hours == 12, [Hide("HouseToiletScreen"), Jump("LilSisNightEvent34")])
