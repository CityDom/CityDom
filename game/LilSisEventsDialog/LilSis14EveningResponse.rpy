label LilSisEvening14:
    ...
    menu:
        "Knock":
            ...
            $ Location = "Hallway"   
        "Peek":
            scene EVENING24LILSIS1 with Dissolve(0.5)
            ...
            scene EVENING24LILSIS2 with Dissolve(0.5)
            MC "{color=#808080}*I can't get enough of seeing her ass.*{color=#808080}"
            scene EVENING24LILSIS3 with Dissolve(0.5)
            ...
            menu:
                "Stay":
                    ...
                    scene EVENING24LILSIS9 with Dissolve(0.5)
