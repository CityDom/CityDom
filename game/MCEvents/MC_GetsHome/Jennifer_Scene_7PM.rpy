...
label MC_GetsHome_Jennifer_7PM:
    ...
    menu:
        "Knock":
            ...
            McMom "Oh, c'mon, [MC], what are you doing there?"
            McMom "Get up!"
            ...
            McMom "I told you I can't keep up with the words you kids use these days. I didn't understand a single thing."
            McMom "Now get up, the floor is cold, and you're getting your pants dirty!"
            scene Jennifer_Scene_7PM_16 with Dissolve(0.5)
            McMom "What are you doing laying on the ground here?!"
            ...
            McMom "Stop fighting and get in the house right now!"
