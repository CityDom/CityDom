init python:
    def get_upper_name(character):
        # Since character is now a variable holding the name as a string, simply return its uppercase version.
...
label GameIntro:
    ...
    McMom "{color=#808080}*Uhhh... please don't tell me that's not [MC]...*{/color}"
    ...
    McMom "Come to mommy kiddo, I missed you so much!!"
    scene introscene14 with Dissolve(1)
    McMom "Come here! You've grown so much!"
    McMom "You are almost as tall as me now!"
    ...
    McMom "You've grown into such a handsome young man!"
    scene introscene15 with Dissolve(0.5)
    MC "I can't breathe!!!"
    scene introscene17 with Dissolve(0.5)
    McMom "Oh yeah, sorry, I'm just so happy to see you!"
    scene introscene18 with Dissolve(0.5)
    McMom "How long has it been?"
    McMom "I think at least a couple of years!"
    scene IntroScene19 with Dissolve(0.5)
    MC "I think way more than that mom..."
    MC "At least six or seven..."
    scene introscene18 with Dissolve(0.5)
    McMom "Haha! I might've lost track of time then."
    McMom "With the two little devils on my head all the time."
    show IntroVideo2
    McMom "Speaking of the devil..."
    scene introscene24 with Dissolve(0.5)
    McMom "I was wondering when she was going to show up."
    ...
    McMom "Isabella, wait! You don't have any shoes on!"
    ...
    McMom "I don't know what you kids are talking about there, but stop fighting!"
    scene introscene40 with Dissolve(0.5)
    McMom "Isa, get off your brother, he's hurt!"
    McMom "And you shouldn't sit on him like that anyways!"
    ...
    McMom "Just get off of him already and let's go inside!"
    McMom "[MC] must be tired from the road."
    scene introscene47 with Dissolve(0.5)
    Clair "What's with all the fuss?"
    Clair "Mom, is breakfast ready yet? What are y'all doing?"
    scene introscene49 with Dissolve(0.5)
    Clair "And who is that guy?"
    Clair "Don't tell me Isabella finally got a boyfriend."
    show IntroVideo3
    ...
    Clair "You got some nerve in you, Isabella!"
    Clair "How about you shut up before I come over there and shut you up myself in front of your boyfriend?"
    scene IntroScene52 with Dissolve(0.5)
    McMom "CLAIRE! ISABELLA!"
    McMom "Stop fighting now!"
    McMom "And that's not her boyfriend!"
    McMom "It's your brother!"
    McMom "[MC] arrived."
    scene IntroScene53 with Dissolve(0.5)
    MC "Hey, Claire! Long time no see, right?"
    scene IntroScene54 with Dissolve(0.5)
    Clair "Oh great... The loser is back."
    Clair "Is that all the fuss?"
    Clair "And why is Isa on top of him? That's disgusting!"
    scene IntroScene55 with Dissolve(0.5)
    Clair "Wait... does that mean..."
    scene IntroScene56 with Dissolve(0.5)
    Clair "That dad is here as well?"
    ...
    Clair "Ughhh..."
    Clair "Thanks a lot, mom! You managed to ruin everything again!!"
    Clair "Now, are you making breakfast or not? I have to leave for school!"
    scene IntroScene59 with Dissolve(0.5)
    McMom "I'm sorry, Claire, I didn't mean to do that."
    McMom "I didn't even see him."
    McMom "I'll help [MC] with his luggage and make breakfast."
    scene IntroScene60 with Dissolve(0.5)
    Clair "UGHHHH!! Just do it already!"
    ...
    McMom "I'm sorry for that, [MC]... It's my fault."
    McMom "So don't think bad of her."
    McMom "She's not always like that!"
    ...
    scene IntroScene61 with Dissolve(0.5)
    McMom "Anyway, let's go inside."
    McMom "I guess you are hungry, [MC]."
    McMom "I'll make breakfast."
    scene IntroScene99 with Dissolve(0.5)
    McMom "Isa, help [MC] with his luggage."
    scene IntroScene67 with Dissolve(0.5)
    McMom "Speaking of that... Where is your stuff?"
    McMom "I only saw you with a backpack and that's gone as well now."
    ...
    McMom "Ughhh... I knew that asshole was good for nothing."
    McMom "And where is your backpack?"
    scene IntroScene64 with Dissolve(0.5)
    MC "Uhhh..."
    ...
    scene IntroScene67 with Dissolve(0.5)
    McMom "Okay, [MC], I'll go prepare the breakfast."
    scene IntroScene68 with Dissolve(0.5)
    McMom "Isa, help [MC] find his backpack and get him to his room."
    scene IntroScene69 with Dissolve(0.5)
    Isabella "Okay, mom!"
    scene IntroScene68 with Dissolve(0.5)
    McMom "Come in like 30 minutes to eat."
    ...
    McMom "[MC_upper]!!!!!"
    McMom "DON'T TELL ME YOU ARE STILL SLEEPING!!"
    McMom "COME DOWN TO EAT ALREADY!!!"
