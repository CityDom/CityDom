screen SchoolPoolScreen():
    if (not school_clock.IsBreak and school_clock.period < 8) or school_clock.period == 9 or school_clock.period == 10:
        ...
        imagebutton:
            ...
            xpos 946
            ypos 250
            action [Hide("SchoolPoolScreen"), Jump("BeforeSwimClassScene")]
            focus_mask True
        ...
        imagebutton:
            ...
            xpos 1467
            ypos 235
            action [Hide("SchoolPoolScreen"), Jump("SwimClass_Maria_Scene")]
            focus_mask True
        imagebutton:
            ...
            xpos 1005
            ypos 234
            action [Hide("SchoolPoolScreen"), Jump("SwimClass_Helena_Alis_Sophie_Scene")]
            focus_mask True
        imagebutton:
            ...
            xpos 378
            ypos 475
            action [Hide("SchoolPoolScreen"), Jump("SwimClass_Selina_Greta_Scene")]
            focus_mask True
        imagebutton:
            ...
            xpos 1715
            ypos 267
            action [Hide("SchoolPoolScreen"), Jump("SwimClass_Isabella_Criss_Scene")]
            focus_mask True
        imagebutton:
            ...
            xpos 1202
            ypos 594
            action [Hide("SchoolPoolScreen"), Jump("SwimClass_AnnaEmma_Scene")]
            focus_mask True
        imagebutton:
            ...
            xpos 336
            ypos 303
            action [Hide("SchoolPoolScreen"), Jump("SwimClass_Lola_Leya_Scene")]
            focus_mask True
        imagebutton:
            ...
            xpos 235
            ypos 96
            action [Hide("SchoolPoolScreen"), Jump("SwimClass_Tanya_Dorothy_Scene")]
            focus_mask True
        imagebutton:
            auto "MoveRightArrowSmaller_%s.png"
            xpos 850
            ypos 650
            action [Hide("SchoolPoolScreen"), Jump("SwimClass_Scene")]
        ...
        imagebutton:
            ...
            xpos 1213
            ypos 592
            action [Hide("SchoolPoolScreen"), Jump("AnnaAndEmmaFirstPauseScene")]
            focus_mask True
    else:
