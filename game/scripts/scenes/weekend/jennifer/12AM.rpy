init python:
    define_images("Jennifer_weekend_12AM_", "WeekendScenes/JenniferScenes/12AM", "Jennifer_weekend_12AM_", 100)

label Jennifer_weekend_12AM:
    scene Jennifer_weekend_12AM_1 with Dissolve(0.5)
    MC "{color=#808080}*Seems like someone is using the toilet.*{/color}"

    jump Jennifer_weekend_12AM_menu


label Jennifer_weekend_12AM_menu:
    menu:
        "Knock":
        ...
        "Peep":
            scene Jennifer_weekend_12AM_2 with Dissolve(0.5)
        ...
        "Open":
            scene Jennifer_weekend_12AM_3 with Dissolve(0.5)
