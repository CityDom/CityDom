label MovieNightLVL1:
    ...
    menu:
        "Join them":
            ...
            McMom "Oh hey kiddo, we are deciding on what movie to watch."
            MC "Can I join?"
            McMom "Sure, come here."
            scene MovieScene30 with Dissolve(0.5)
            McMom "So... ummm... what movie do you kids want to watch?"
            scene MovieScene32 with Dissolve(0.5)
            MC "Can I choose?"
            scene MovieScene30 with Dissolve(0.5)
            McMom "Sure, We can never decide anyway."
            ...
            label MovieChoise_menu:
                ...
                menu:
                    "Action":
                        ...
                        scene MovieScene30 with Dissolve(0.5)
                        McMom "Oke, an action movie it is!"
                        scene MovieScene33 with Dissolve(0.5)
                        Clair "C'mon mom, are we really gonna let him choose the movie? I bet it's gonna be shit!"
                        scene MovieScene34 with Dissolve(0.5)
                        McMom "Watch your mouth Clair, I said we are letting [MC] choose for this night."
                        Clair "Tsk... Fine... I'll try not to fall asleep."
                        ...
                        menu:
                            "Jennifer":
                                ...
                                McMom "Take your hand off kiddo."
                                MC "Yep, oke.."
                                scene MovieScene24 with Dissolve(0.5)
                            ...
                            "Claire":
                                ...
                                Clair "I'm trying to watch this boring movie, don't talk to me, loser."
                                scene MovieScene24 with Dissolve(0.5)
                    ...
                    "Romance":
                        ...
                        scene MovieScene30 with Dissolve(0.5)
                        McMom "Oke, a romance movie it is!"
                        scene MovieScene33 with Dissolve(0.5)
                        Clair "C'mon mom, are we really gonna let him choose the movie? I bet it's gonna be shit!"
                        scene MovieScene34 with Dissolve(0.5)
                        McMom "Watch your mouth Clair, I said we are letting [MC] choose for this night."
                        ...
                        menu:
                            "Jennifer":
                                McMom "Oh, this is so beautiful... and so sad at the same time."
                                MC "{color=#808080}*Maybe I could console her...*{/color}"
                                scene MovieScene36 with Dissolve(0.5)
                                MC " Mom, are you okay?"
                                scene MovieScene37 with Dissolve(0.5)
                                McMom "Yeah kiddo, I'm okay. Love stories always tear me up."
                                McMom "They remind me of my younger days."
                                ...
                                McMom "Awww, that's cute [MC], now let me watch the movie."
                            ...
                            "Claire":
                                ...
                                Clair "I'm trying to watch this cringe crap, leave me alone!"
                                MC "...."
                                scene MovieScene35 with Dissolve(0.5)
                                MC "{color=#808080}*I expected as much*{/color}"
                                scene BlackScreen with Dissolve(0.5)
                    ...
                    "Horror":
                        ...
                        scene MovieScene30 with Dissolve(0.5)
                        McMom "Ughh... I get scared really easily... but I guess we could watch that."
                        scene MovieScene33 with Dissolve(0.5)
                        Clair "C'mon mom, are we really gonna let him choose the movie? I bet it's gonna be shit!"
                        scene MovieScene34 with Dissolve(0.5)
                        McMom "Watch your mouth Clair, I said we are letting [MC] choose for this night."
                        ...
                        menu:
                            "Jennifer":
                                ...
                                McMom "AAAAAAAAAAAAAAAAAAAAAAAAAAAAA!!!!!!!!!!!!!"
                                ...
                                Clair "You finally did something kinda funny, dumbass."
                                scene MovieScene53 with Dissolve(0.5)
                                McMom "OMG [MC] YOU SCARED THE SOUL OUT OF ME!!"
                                MC "I'm sorry mom I just wanted to-"
                                McMom "Don't EVER do that again! Do you understand?!!?!?"
                                MC "But I just-"
                                McMom "Let me watch the movie and stay put!"
                            ...
                            "Isabella":
                                ...
                                McMom "AAAAAAAAAAAAAA!!!!!"
                                Isabella "AAAAAAAA!!!!!"
                                Clair "Hehe, I was just thinking about doing that."
                            ...
                            "Claire":
                                ...
                                MC "Hey Clair, how are you liking the movie?"
                                scene MovieScene60 with Dissolve(0.5)
                                Clair "It's not complete dogshit, I might be able to stay awake."
                                Clair "Now stop talking and let me watch the movie!"
                                scene MovieScene58 with Dissolve(0.5)
                                MC "I'm glad you like the movie I suggested!"
                                scene MovieScene60 with Dissolve(0.5)
                                Clair "Yeah whatever, now shut up!"
                                MC "okay, geez..."
                                scene BlackScreen with Dissolve(0.5)
                                "{color=#808080}**You watch the rest of the movie and leave**{/color}"
                                $ Location = "Entrance"
